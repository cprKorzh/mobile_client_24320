    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: bgColor}}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: textColor}]}>Результаты</Text>
                <View style={{width: 24}}/>
            </View>
            <ScrollView style={styles.container}>
                <View style={[styles.card, {backgroundColor: cardBgColor}]}>
                    <Ionicons name="pie-chart-outline" size={48} color="#1ABC9C"/>
                    <Text style={[styles.cardTitle, {color: textColor}]}>Статистика и результаты</Text>
                    <Text style={[styles.cardDescription, {color: textColor, opacity: 0.7}]}>
                        Анализ ваших результатов и прогресса обучения
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
