  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: bgColor }}>
      <View style={styles.header}>
        ...
        <Text style={[styles.title, { color: textColor }]}>Правила</Text>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView style={styles.container}>
        <View style={[styles.card, { backgroundColor: cardBgColor }]}>
          <Ionicons name="book-outline" size={48} color="#95A5A6" />
          <Text style={[styles.cardTitle, { color: textColor }]}>Правила дорожного движения</Text>
          <Text style={[styles.cardDescription, { color: textColor, opacity: 0.7 }]}>
            Полный текст ПДД с комментариями и пояснениями
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
