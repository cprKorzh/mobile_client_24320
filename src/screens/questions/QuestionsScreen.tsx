    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: bgColor}}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: textColor}]}>Вопросы</Text>
                <View style={{width: 24}}/>
            </View>
            <ScrollView style={styles.container}>
                <View style={[styles.card, {backgroundColor: cardBgColor}]}>
                    <Ionicons name="help-circle-outline" size={48} color="#3498DB"/>
                    <Text style={[styles.cardTitle, {color: textColor}]}>База вопросов ПДД</Text>
                    <Text style={[styles.cardDescription, {color: textColor, opacity: 0.7}]}>
                        Изучайте вопросы по категориям и темам
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
