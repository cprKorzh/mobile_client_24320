    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: bgColor}}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: textColor}]}>План</Text>
                <View style={{width: 24}}/>
            </View>
            <ScrollView style={styles.container}>
                <View style={[styles.card, {backgroundColor: cardBgColor}]}>
                    <Ionicons name="map-outline" size={48} color="#8E44AD"/>
                    <Text style={[styles.cardTitle, {color: textColor}]}>План обучения</Text>
                    <Text style={[styles.cardDescription, {color: textColor, opacity: 0.7}]}>
                        Ваш индивидуальный план изучения ПДД
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
