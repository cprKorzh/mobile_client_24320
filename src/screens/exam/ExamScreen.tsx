    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: bgColor}}>
            <View style={styles.header}>
                ...
                <Text style={[styles.title, {color: textColor}]}>Экзамен</Text>
                <View style={{width: 24}}/>
            </View>
            <ScrollView style={styles.container}>
                <View style={[styles.card, {backgroundColor: cardBgColor}]}>
                    <Ionicons name="document-text-outline" size={48} color="#E74C3C"/>
                    <Text style={[styles.cardTitle, {color: textColor}]}>Экзаменационные билеты</Text>
                    <Text style={[styles.cardDescription, {color: textColor, opacity: 0.7}]}>
                        Подготовка к официальному экзамену в ГИБДД
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
